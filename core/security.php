<?php
	...
	if(!isset($_SESSION['ORIGIN_IP'])){
		...
		if (strcmp($_SESSION['ORIGIN_IP'] , $actual_ip) !== 0) {
			...
			include $_SERVER['DOCUMENT_ROOT'].'/includes/mailing/security/not_equal_ip.php'; //aqu� tenemos el cuerpo del mensaje
			enviar_email(security_mail, $asunto, $cuerpo);
			//realizamos la expulsi�n de seguridad
			expulsion_seguridad();
		}
	}
	...
	//como medida de seguridad b�sica, vamos a limpiar todas las variables por defecto
