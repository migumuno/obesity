...
$(document).ready(function() 
{
	...
	{
		$("body").prepend("<div class='cookies_obesity_ok'><p><a href='#' class='close'>cerrar mensaje</a>Esta web utiliza 'cookies' propias y de terceros para ofrecerle una mejor experiencia y servicio. Al navegar o utilizar nuestros servicios el usuario acepta el uso que hacemos de las 'cookies'. <a href='/legal'>M&aacute;s informaci&oacute;n</a></p></div>");
