								...
								<div class="row">
									<div class="col-xs-12 form-diagnostico">
										...
										<div class="col-md-12 col-sm-12">
											...
											<span class="form_check"><input ng-model="politica" type="checkbox" name="politica" required> <small><?php echo $diccionario->fields->privacity->$_SESSION['lang'] ?></small></span>
