								...
								<div class="row">
									<div class="col-xs-12 form-diagnostico">
										...
										<div class="col-md-12 col-sm-12">
											...
											<span class="form_check"><input ng-model="politica" type="checkbox" name="politica" required> <small><a href='/legal'>{{dictionary.fields.privacity[lang]}}</a></small></span>
											...
											<input class="boton" type="submit" value="{{dictionary.fields.button[lang]}}" ng-disabled="!form_method.$valid">
										</div>
									</div>
								</div>
							</form>
