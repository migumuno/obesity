		...
		<div class="row">
			<div class="col-sm-6 padding20">
				...
				for ($i=0; $i<count($text); $i++) {
					echo '<p ng-bind-html="interpretar(text[lang])">'.traducirStringXml($text[$i]->$_SESSION['lang']).'</p>';
				}
				?>
			</div>
			<div class="col-sm-6 padding20">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				for ($i=0; $i<count($tarjetas); $i++) {
					echo '
					<div class="col-md-6 col-sm-6 caracteristica_metodo">
						...
						<div class="contenido_caracteristica">
							...
							<div class="txt_alojamiento">
								<p>'.traducirStringXml($tarjetas[$i]->text->$_SESSION['lang']).'</p>
							</div>
							<div class="boton_diagnostico"><a href="'.$tarjetas[$i]->link->$_SESSION['lang'].'" target="_blank"><button class="boton">'.$diccionario->buttons->visit->$_SESSION['lang'].'</button></a></div>
						</div>
					</div>
					';
				}
